...
window.dataCache = {
    reviews: {
        data: [],
        lastUpdate: 0,
        updateInterval: 5 * 1000 // 5 секунд для мгновенного обновления
    },
    requests: {
        data: [],
        lastUpdate: 0,
        updateInterval: 5 * 1000 // 5 секунд для мгновенного обновления заказов
    },
    chat_orders: {
        data: {},
        lastUpdate: 0,
        updateInterval: 5 * 1000 // 5 секунд для мгновенного обновления чата
    },
    chat_messages: {
        data: {},
        lastUpdate: 0,
    ...
    stats: {
        data: {},
        lastUpdate: 0,
        updateInterval: 5 * 1000 // 5 секунд для мгновенного обновления статистики
    },
    averageRating: {
        data: null,
        lastUpdate: 0,
        updateInterval: 5 * 1000 // 5 секунд для мгновенного обновления рейтинга
    }
};
...
function startPeriodicUpdates() {
    ...
    // Обновление отзывов каждые 5 секунд для мгновенного отображения
    reviewsUpdateInterval = setInterval(() => {
        console.log('🔄 Быстрое обновление отзывов...');
    ...
    // Обновление чата каждые 5 секунд для мгновенного отображения
    chatUpdateInterval = setInterval(() => {
        console.log('🔄 Быстрое обновление чата...');
        loadChatMessagesFromDB(true);
        loadChatOrdersFromDB(true);
    ...
    // Обновление заказов каждые 5 секунд для мгновенного отображения
    ordersUpdateInterval = setInterval(() => {
        console.log('🔄 Быстрое обновление заказов...');
        loadDataWithFallback('requests', true);
    ...
    console.log('⏰ Быстрое обновление данных каждые 5 секунд запущено');
}
...
function stopPeriodicUpdates() {
    ...
    console.log('⏹️ Быстрое обновление данных остановлено');
}
